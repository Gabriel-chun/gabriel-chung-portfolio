  ...
  return (
    <section id="projects" className="py-20 md:py-28 px-6">
      <div className="max-w-6xl mx-auto">
        <p className="text-sm font-mono text-[#3E5C76] tracking-widest uppercase mb-3">
          {t.label}
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {t.items.map((project) => (
            <article
              key={project.title}
              className="group border border-[#E0DDD8] rounded bg-white overflow-hidden flex flex-col hover:border-[#3E5C76]/40 transition-colors"
            >
                  {project.image && (
              <div className="aspect-[16/9] w-full overflow-hidden border-b border-[#E0DDD8] bg-[#F0F0EE]">
                <img
                  src={project.image}
                  alt={project.title}
